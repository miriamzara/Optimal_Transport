...
with open('OT_SINKHORN_piano_0.0008.txt', 'r') as file:
...
ax1.bar(X2,Y2, width=100./numero_bin, align="edge", color='blue', alpha=0.5)
ax1.set_xlim(0,100)
ax1.xaxis.tick_top()
...
ax2.barh(X1,Y1, height=100./numero_bin, align="edge", color='red', alpha=0.5)
...
y = 60+2*(x-20)
ax3.invert_yaxis()
ax3.plot(y,x, linestyle="dotted", color="black")
...
plt.suptitle(r'parametro $\beta=0.8e+06$, costo p=2', fontsize=16,x=0.2,y=0.95)


plt.savefig('gauss_free_best.png', bbox_inches='tight')
plt.savefig('gauss_free_best.svg', bbox_inches='tight')
